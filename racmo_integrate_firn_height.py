...
def integrate_racmo_firn(base_dir, MODEL, VARIABLE='zs', OUTPUT=True):
...
def main():
	...
	zs,tzs = integrate_racmo_firn(base_dir, MODEL, VARIABLE='zs')
	air,tair = integrate_racmo_firn(base_dir, MODEL, VARIABLE='FirnAir')
