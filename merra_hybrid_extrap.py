...
def merra_hybrid_extrap(base_dir, REGION, COORDINATES=None,
	...
	air,itype,fv = extrapolate_merra_hybrid(base_dir, EPSG, REGION, tdec, X, Y,
...
#-- Main program that calls merra_hybrid_extrap()
def main():
	...
	merra_hybrid_extrap(base_dir, REGION, COORDINATES=COORDINATES,
